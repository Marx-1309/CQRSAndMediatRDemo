...
{
    public class UpdateStudentHandler : IRequestHandler<CQRSAndMediatRDemo.Commands.UpdateStudentCommand, int>
    {
        ...
        public async Task<int> Handle(CQRSAndMediatRDemo.Commands.UpdateStudentCommand command, CancellationToken cancellationToken)
        {
